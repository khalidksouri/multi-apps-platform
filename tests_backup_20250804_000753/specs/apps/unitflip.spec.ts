...
test.describe('unitflip - Application Tests', () => {
  
  test('unitflip loads successfully', async ({ page }) => {
    await page.goto('http://localhost:300postmath  budgetcron ai4kids multiai')
  ...
  test('unitflip language switching works', async ({ page }) => {
    await page.goto('http://localhost:300postmath  budgetcron ai4kids multiai')
