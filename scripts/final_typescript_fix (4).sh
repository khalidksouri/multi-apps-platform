  ...
  pt: {
    ...
    yes: 'Sim', no: 'Não', ok: 'OK', cancel: 'Cancelar', loading: 'Carregando...', error: 'Erro',
  ...
  nl: {
    ...
    yes: 'Ja', no: 'Nee', ok: 'OK', cancel: 'Annuleren', loading: 'Laden...', error: 'Fout',
  ...
  ru: {
    ...
    yes: 'Да', no: 'Нет', ok: 'ОК', cancel: 'Отмена', loading: 'Загрузка...', error: 'Ошибка',
  ...
  pl: {
    ...
    yes: 'Tak', no: 'Nie', ok: 'OK', cancel: 'Anuluj', loading: 'Ładowanie...', error: 'Błąd',
  ...
  sv: {
    ...
    yes: 'Ja', no: 'Nej', ok: 'OK', cancel: 'Avbryt', loading: 'Laddar...', error: 'Fel',
  ...
  // Dansk
  da: {
    home: 'Hjem', exercises: 'Øvelser', progress: 'Fremgang', settings: 'Indstillinger', help: 'Hjælp',
    appName: 'Math4Child', tagline: 'Lær matematik mens du har det sjovt!', startLearning: 'Begynd at lære',
    welcomeMessage: 'Velkommen til det matematiske eventyr!', description: 'Uddannelsesapp til at lære matematik.',
    badge: '#1 Uddannelsesapp i Frankrig', startFree: 'Start gratis', freeTrial: '14 dage gratis',
    viewPlans: 'Se planer', choosePlan: 'Vælg denne plan', familiesCount: '100k+ familier stoler på os',
    pricing: 'Abonnementsplaner', monthly: 'Månedligt', quarterly: 'Kvartalsvis', annual: 'Årligt',
    save: 'Spar', mostPopular: 'Mest populære', recommended: 'Anbefalet til familier',
    freeVersion: 'Gratis version', premiumPlan: 'Premium', familyPlan: 'Familie', free: 'Gratis',
    addition: 'Addition', subtraction: 'Subtraktion', multiplication: 'Multiplikation', division: 'Division',
    beginner: 'Begynder', intermediate: 'Mellem', advanced: 'Avanceret', expert: 'Ekspert', master: 'Mester',
    score: 'Score', level: 'Niveau', streak: 'Serie', timeLeft: 'Tid tilbage',
    correct: 'Korrekt!', incorrect: 'Forkert', congratulations: 'Tillykke!',
    next: 'Næste', previous: 'Forrige', continue: 'Fortsæt', restart: 'Genstart', quit: 'Afslut', play: 'Spil', pause: 'Pause',
    yes: 'Ja', no: 'Nej', ok: 'OK', cancel: 'Annuller', loading: 'Indlæser...', error: 'Fejl',
    gamesPlayed: 'Spil spillet', averageScore: 'Gennemsnitsscore', totalTime: 'Total tid', bestStreak: 'Bedste serie',
    welcome: 'Velkommen!', goodJob: 'Godt arbejde!', tryAgain: 'Prøv igen', levelComplete: 'Niveau færdigt!', newRecord: 'Ny rekord!',
    testimonials: 'Anbefalinger', faq: 'FAQ', featuresFooter: 'Funktioner', contact: 'Kontakt', allRightsReserved: 'Alle rettigheder forbeholdes.',
  },

  // Norsk
  no: {
    home: 'Hjem', exercises: 'Øvelser', progress: 'Fremgang', settings: 'Innstillinger', help: 'Hjelp',
    appName: 'Math4Child', tagline: 'Lær matematikk mens du har det gøy!', startLearning: 'Begynn å lære',
    welcomeMessage: 'Velkommen til det matematiske eventyret!', description: 'Utdanningsapp for å lære matematikk.',
    badge: '#1 Utdanningsapp i Frankrike', startFree: 'Start gratis', freeTrial: '14 dager gratis',
    viewPlans: 'Se planer', choosePlan: 'Velg denne planen', familiesCount: '100k+ familier stoler på oss',
    pricing: 'Abonnementsplaner', monthly: 'Månedlig', quarterly: 'Kvartalsvis', annual: 'Årlig',
    save: 'Spar', mostPopular: 'Mest populære', recommended: 'Anbefalt for familier',
    freeVersion: 'Gratis versjon', premiumPlan: 'Premium', familyPlan: 'Familie', free: 'Gratis',
    addition: 'Addisjon', subtraction: 'Subtraksjon', multiplication: 'Multiplikasjon', division: 'Divisjon',
    beginner: 'Nybegynner', intermediate: 'Mellom', advanced: 'Avansert', expert: 'Ekspert', master: 'Mester',
    score: 'Poeng', level: 'Nivå', streak: 'Serie', timeLeft: 'Tid igjen',
    correct: 'Riktig!', incorrect: 'Feil', congratulations: 'Gratulerer!',
    next: 'Neste', previous: 'Forrige', continue: 'Fortsett', restart: 'Start på nytt', quit: 'Avslutt', play: 'Spill', pause: 'Pause',
    yes: 'Ja', no: 'Nei', ok: 'OK', cancel: 'Avbryt', loading: 'Laster...', error: 'Feil',
    gamesPlayed: 'Spill spilt', averageScore: 'Gjennomsnittsscore', totalTime: 'Total tid', bestStreak: 'Best serie',
    welcome: 'Velkommen!', goodJob: 'Godt jobbet!', tryAgain: 'Prøv igjen', levelComplete: 'Nivå fullført!', newRecord: 'Ny rekord!',
    testimonials: 'Anbefalinger', faq: 'FAQ', featuresFooter: 'Funksjoner', contact: 'Kontakt', allRightsReserved: 'Alle rettigheter forbeholdt.',
  },

  // Suomi (Finnois)
  fi: {
    home: 'Koti', exercises: 'Harjoitukset', progress: 'Edistyminen', settings: 'Asetukset', help: 'Apua',
    appName: 'Math4Child', tagline: 'Opi matematiikkaa hauskanpidossa!', startLearning: 'Aloita oppiminen',
    welcomeMessage: 'Tervetuloa matemaattiseen seikkailuun!', description: 'Opetussovellus matematiikan oppimiseen.',
    badge: '#1 Opetussovellus Ranskassa', startFree: 'Aloita ilmaiseksi', freeTrial: '14 päivää ilmaiseksi',
    viewPlans: 'Katso suunnitelmat', choosePlan: 'Valitse tämä suunnitelma', familiesCount: '100k+ perhettä luottaa meihin',
    pricing: 'Tilaussuunnitelmat', monthly: 'Kuukausittain', quarterly: 'Neljännesvuosittain', annual: 'Vuosittain',
    save: 'Säästä', mostPopular: 'Suosituin', recommended: 'Suositeltu perheille',
    freeVersion: 'Ilmainen versio', premiumPlan: 'Premium', familyPlan: 'Perhe', free: 'Ilmainen',
    ...
    score: 'Pisteet', level: 'Taso', streak: 'Sarja', timeLeft: 'Aikaa jäljellä',
    correct: 'Oikein!', incorrect: 'Väärin', congratulations: 'Onnittelut!',
    next: 'Seuraava', previous: 'Edellinen', continue: 'Jatka', restart: 'Käynnistä uudelleen', quit: 'Lopeta', play: 'Pelaa', pause: 'Tauko',
    yes: 'Kyllä', no: 'Ei', ok: 'OK', cancel: 'Peruuta', loading: 'Lataa...', error: 'Virhe',
    gamesPlayed: 'Pelatut pelit', averageScore: 'Keskimääräinen pistemäärä', totalTime: 'Kokonaisaika', bestStreak: 'Paras sarja',
    welcome: 'Tervetuloa!', goodJob: 'Hyvää työtä!', tryAgain: 'Yritä uudelleen', levelComplete: 'Taso valmis!', newRecord: 'Uusi ennätys!',
    testimonials: 'Todistukset', faq: 'UKK', featuresFooter: 'Ominaisuudet', contact: 'Yhteystiedot', allRightsReserved: 'Kaikki oikeudet pidätetään.',
  },
  ...
  zh: {
    ...
    yes: '是', no: '否', ok: '确定', cancel: '取消', loading: '加载中...', error: '错误',
  ...
  ja: {
    ...
    yes: 'はい', no: 'いいえ', ok: 'OK', cancel: 'キャンセル', loading: '読み込み中...', error: 'エラー',
  ...
  ko: {
    ...
    yes: '예', no: '아니오', ok: '확인', cancel: '취소', loading: '로딩 중...', error: '오류',
  ...
  hi: {
    ...
    yes: 'हां', no: 'नहीं', ok: 'ठीक है', cancel: 'रद्द करें', loading: 'लोड हो रहा है...', error: 'त्रुटि',
  ...
  th: {
    ...
    yes: 'ใช่', no: 'ไม่', ok: 'ตกลง', cancel: 'ยกเลิก', loading: 'กำลังโหลด...', error: 'ข้อผิดพลาด',
  ...
  vi: {
    ...
    yes: 'Có', no: 'Không', ok: 'OK', cancel: 'Hủy', loading: 'Đang tải...', error: 'Lỗi',
    gamesPlayed: 'Trò chơi đã chơi', averageScore: 'Điểm trung bình', totalTime: 'Tổng thời gian', bestStreak: 'Chuỗi tốt nhất',
    welcome: 'Chào mừng!', goodJob: 'Làm tốt!', tryAgain: 'Thử lại', levelComplete: 'Hoàn thành cấp độ!', newRecord: 'Kỷ lục mới!',
    testimonials: 'Lời chứng thực', faq: 'Câu hỏi thường gặp', featuresFooter: 'Tính năng', contact: 'Liên hệ', allRightsReserved: 'Tất cả quyền được bảo lưu.',
  },
  ...
  he: {
    ...
    yes: 'כן', no: 'לא', ok: 'אישור', cancel: 'ביטול', loading: 'טוען...', error: 'שגיאה',
  ...
  // فارسی (RTL)
  fa: {
    home: 'خانه', exercises: 'تمرین‌ها', progress: 'پیشرفت', settings: 'تنظیمات', help: 'کمک',
    ...
    viewPlans: 'مشاهده طرح‌ها', choosePlan: 'این طرح را انتخاب کنید', familiesCount: '100k+ خانواده به ما اعتماد دارند',
    ...
    freeVersion: 'نسخه رایگان', premiumPlan: 'پریمیوم', familyPlan: 'خانواده', free: 'رایگان',
    ...
    score: 'امتیاز', level: 'سطح', streak: 'توالی', timeLeft: 'زمان باقی‌مانده',
    correct: 'درست!', incorrect: 'نادرست', congratulations: 'تبریک!',
    next: 'بعدی', previous: 'قبلی', continue: 'ادامه', restart: 'شروع مجدد', quit: 'خروج', play: 'بازی', pause: 'توقف',
    yes: 'بله', no: 'خیر', ok: 'تایید', cancel: 'لغو', loading: 'در حال بارگذاری...', error: 'خطا',
    gamesPlayed: 'بازی‌های انجام شده', averageScore: 'میانگین امتیاز', totalTime: 'زمان کل', bestStreak: 'بهترین توالی',
    welcome: 'خوش آمدید!', goodJob: 'آفرین!', tryAgain: 'دوباره تلاش کنید', levelComplete: 'سطح تکمیل شد!', newRecord: 'رکورد جدید!',
    testimonials: 'شهادت‌نامه‌ها', faq: 'سوالات متداول', featuresFooter: 'ویژگی‌ها', contact: 'تماس', allRightsReserved: 'تمام حقوق محفوظ است.',
  },

  // اردو (RTL)
  ur: {
    home: 'گھر', exercises: 'مشقیں', progress: 'پیش قدمی', settings: 'سیٹنگز', help: 'مدد',
    appName: 'Math4Child', tagline: 'خوشی سے ریاضی سیکھیں!', startLearning: 'سیکھنا شروع کریں',
    welcomeMessage: 'ریاضی کی مہم جوئی میں خوش آمدید!', description: 'ریاضی سیکھنے کے لیے تعلیمی ایپ۔',
    badge: 'فرانس میں نمبر 1 تعلیمی ایپ', startFree: 'مفت شروع کریں', freeTrial: '14 دن مفت',
    viewPlans: 'منصوبے دیکھیں', choosePlan: 'یہ منصوبہ منتخب کریں', familiesCount: '100k+ خاندان ہم پر بھروسہ کرتے ہیں',
    pricing: 'سبسکرپشن منصوبے', monthly: 'ماہانہ', quarterly: 'سہ ماہی', annual: 'سالانہ',
    save: 'بچت', mostPopular: 'سب سے مقبول', recommended: 'خاندانوں کے لیے تجویز کردہ',
    freeVersion: 'مفت ورژن', premiumPlan: 'پریمیم', familyPlan: 'خاندان', free: 'مفت',
    addition: 'جمع', subtraction: 'تفریق', multiplication: 'ضرب', division: 'تقسیم',
    beginner: 'ابتدائی', intermediate: 'درمیانی', advanced: 'اعلیٰ', expert: 'ماہر', master: 'استاد',
    score: 'اسکور', level: 'لیول', streak: 'تسلسل', timeLeft: 'باقی وقت',
    correct: 'درست!', incorrect: 'غلط', congratulations: 'مبارک ہو!',
    next: 'اگلا', previous: 'پچھلا', continue: 'جاری رکھیں', restart: 'دوبارہ شروع', quit: 'چھوڑیں', play: 'کھیلیں', pause: 'رک جائیں',
    yes: 'ہاں', no: 'نہیں', ok: 'ٹھیک ہے', cancel: 'منسوخ', loading: 'لوڈ ہو رہا ہے...', error: 'خرابی',
    gamesPlayed: 'کھیلے گئے گیمز', averageScore: 'اوسط اسکور', totalTime: 'کل وقت', bestStreak: 'بہترین تسلسل',
    welcome: 'خوش آمدید!', goodJob: 'بہترین!', tryAgain: 'دوبارہ کوشش کریں', levelComplete: 'لیول مکمل!', newRecord: 'نیا ریکارڈ!',
    testimonials: 'تصدیقات', faq: 'عام سوالات', featuresFooter: 'خصوصیات', contact: 'رابطہ', allRightsReserved: 'تمام حقوق محفوظ ہیں۔',
  },
  ...
  tr: {
    ...
    yes: 'Evet', no: 'Hayır', ok: 'Tamam', cancel: 'İptal', loading: 'Yükleniyor...', error: 'Hata',
...
# Supprime tous les doublons et corrige les erreurs de compilation
# ===================================================================
...
echo -e "${YELLOW}📋 3. Création d'un nouveau fichier translations.ts propre...${NC}"

# Créer un fichier translations.ts complètement nouveau sans doublons
cat > "src/translations.ts" << 'EOF'
/**
 * Traductions Math4Child - Version business propre
 * Système complet avec abonnements et paiements
 */
...
export const translations: Translations = {
  ...
  it: {
    ...
    testimonials: 'Testimonianze', faq: 'FAQ', featuresFootor: 'Caratteristiche', contact: 'Contatto', allRightsReserved: 'Tutti i diritti riservati.',
  },

  // العربية (version compacte RTL)
  ar: {
    home: 'الرئيسية', exercises: 'التمارين', progress: 'التقدم', settings: 'الإعدادات', help: 'المساعدة',
    appName: 'Math4Child', tagline: 'تعلم الرياضيات بمرح!', startLearning: 'ابدأ التعلم',
    welcomeMessage: 'مرحباً بك في مغامرة الرياضيات!', description: 'تطبيق تعليمي لتعلم الرياضيات.',
...
echo -e "${YELLOW}📋 4. Création du hook useTranslation propre...${NC}"
