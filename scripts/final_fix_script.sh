...
# Étape 1: Corriger le CSS de budgetcron (supprimer les commentaires JS)
echo "🎯 ÉTAPE 1: Correction du fichier CSS de budgetcron"

mkdir -p apps/budgetcron/src/app
...
# Étape 2: Corriger le fichier UnitFlip page.tsx (problème TypeScript)
echo "🎯 ÉTAPE 2: Correction du fichier UnitFlip"

mkdir -p apps/unitflip/src/app
...
# Étape 3: Corriger les composants PostMath en supprimant les dépendances lucide-react
echo "🎯 ÉTAPE 3: Simplification des composants PostMath"

mkdir -p apps/postmath/src/components/forms
...
# Étape 4: Corriger les tsconfig.json des applications pour supprimer la référence @cucumber/cucumber
echo "🎯 ÉTAPE 4: Correction des tsconfig.json des applications"
...
# Étape 5: Ajouter lucide-react aux packages PostMath et UnitFlip qui en ont besoin
echo "🎯 ÉTAPE 5: Installation des dépendances manquantes"

echo "📦 Installation de lucide-react pour PostMath..."
cd apps/postmath && npm install lucide-react@latest
cd ../..

echo "📦 Installation de lucide-react pour UnitFlip..."
cd apps/unitflip && npm install lucide-react@latest  
cd ../..

echo "✅ Dépendances installées"

# Étape 6: Rebuild des packages
...
echo "   ✅ tsconfig.json des apps corrigés"
echo "   ✅ Dépendances lucide-react installées"