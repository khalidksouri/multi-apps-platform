...
// Configuration des niveaux de primaire Niveau 1 → Niveau 5
...
const SUBSCRIPTION_PLANS: SubscriptionPlan[] = [
  ...
  },
  {
    ...
    features: [
      '30 profils élèves',
      'Gestion par classe (Niveau 1 à Niveau 5)',
...
export default function Math4ChildPrimary() {
  ...
  const getTexts = (langCode: string) => {
    const texts = {
      'fr': {
        title: 'Math4Child',
        subtitle: 'Progression Niveau 1 → Niveau 5',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        {/* Progression des niveaux Niveau 1 → Niveau 5 */}
